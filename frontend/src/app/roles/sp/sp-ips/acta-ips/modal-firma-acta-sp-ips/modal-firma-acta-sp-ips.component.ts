...
@Component({
  selector: 'app-modal-firma-acta-sp-ips',
  templateUrl: './modal-firma-acta-sp-ips.component.html',
  styleUrls: ['./modal-firma-acta-sp-ips.component.css']
})
export class ModalFirmaActaSpIpsComponent {
