...
@Component({
  selector: 'app-modal-firma-resolucion',
  templateUrl: './modal-firma-resolucion.component.html',
  styleUrls: ['./modal-firma-resolucion.component.css']
})
export class ModalFirmaResolucionComponent {
