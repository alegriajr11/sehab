...
@Component({
  selector: 'app-modal-firma-pamec',
  templateUrl: './modal-firma-pamec.component.html',
  styleUrls: ['./modal-firma-pamec.component.css']
})
export class ModalFirmaPamecComponent {
